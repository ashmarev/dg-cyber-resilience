...
| **2. Объекты информационных систем** | Что внутри системы требует контроля — справочники, НСИ, конфигурации | Управляемы ли объекты системы? | 🔄 Текущий этап — вебинар с Innostage и Arenadata Catalog, 2 июля 2026 |
